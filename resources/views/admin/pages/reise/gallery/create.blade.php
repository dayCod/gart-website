...
@section('title', __('pages.form.create', ['prop' => 'Gallery']))
...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb ms-3 mb-4">
            ...
            <li class="breadcrumb-item active">
                {{ __('pages.form.create', ['prop' => 'Gallery']) }}
            </li>
        </ol>
    </nav>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">{{ __('pages.form.create', ['prop' => 'Gallery']) }}</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.reise.gallery.store') }}" class="row" method="POST"
                ...
                <div class="col-6 mb-3">
                    ...
                    <input type="text" name="production_year" id="production_year"
                        ...
                        value="{{ old('production_year') }}" required>
                ...
                <div class="col-12 mb-3">
                    ...
                    <input type="text" name="instagram_post_url" id="instagram_post_url" class="form-control @error('instagram_post_url') is-invalid @enderror" placeholder="{{ __('pages.form.placeholder', ['prop' => 'Instagram Post URL']) }}" value="{{ old('instagram_post_url') }}">
                ...
                <div class="col-12 mb-3">
                    ...
                    <input type="text" name="tags" id="tags" class="form-control separatorTags @error('tags') is-invalid @enderror" placeholder="{{ __('pages.form.placeholder', ['prop' => 'Tags']) }}" value="{{ old('tags') }}" required>
                ...
                <div class="col-12 mb-3">
                    ...
                    <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror"
                        rows="5" placeholder="{{ __('pages.form.placeholder', ['prop' => 'Description']) }}">{{ old('description') }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <img src="#" onerror="this.src='{{ asset('assets/admin/img/skeleton/not-found-image.png') }}'"
                ...
                <div class="col-md-8 mb-3">
                    ...
                    <input type="file" name="image" id="image"
                        ...
                        onchange="previewFile(this, 'preview-image')" accept="image/*" required>
