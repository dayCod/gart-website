...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('admin.reise.category.update', $category->id) }}" class="row" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="col-md-4 mb-3">
                ...
                <img src="{{ $category->getImageURL(type: 'reise') }}" onerror="this.src='{{ asset('assets/admin/img/skeleton/not-found-image.png') }}'" alt="Gambar / Logo Client" class="preview-image" id="preview-image">
            </div>
