...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin.gart.gallery.update', $gallery->id) }}" class="row" method="POST"
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <img src="{{ $gallery->getImageURL() }}" onerror="this.src='{{ asset('assets/admin/img/skeleton/not-found-image.png') }}'"
