    ...
    <div id="page-header" class="ph-full ph-cap-sm ph-image-cropped ph-image-cover-3 ph-content-parallax">
        <div class="page-header-inner tt-wrap">
            ...
            <div class="ph-caption max-width-1000">
                <h1 class="ph-caption-title ph-appear font-normal">Every story <br>
                    has the power to become an inseparable <em>part of your journey.</em></h1>
                ...
                * Use prepared helper class "max-width-*" to add custom width if needed. Example: "max-width-800". More info about helper classes can be found in the file "helper.css".
                ...
                <div class="tt-heading tt-heading-lg tt-heading-center margin-bottom-10-p anim-fadeinup">
                    ...
                    <div class="tt-btn tt-btn-link margin-top-20">
                        <a href="{{ route('gart.galleries') }}" data-hover="See All Works">See All Works</a>
                    </div>
                </div>
                <!-- End tt-Heading -->
        ...
        <div class="tt-section padding-top-xlg-150 padding-bottom-xlg-150">
            <div class="tt-section-inner">
                ...
                <div class="tt-scrolling-text scr-text-stroke font-italic" data-scroll-speed="15">
                    <div class="tt-scrolling-text-inner text-dark-3" data-text="Your Story Becomes Part of Your Journey -">
                        My Story Becomes Part of My Journey -
            ...
            <div class="tt-section-inner tt-wrap max-width-900">
                ...
                * Use prepared helper class "max-width-*" to add custom width if needed. Example: "max-width-800". More info about helper classes can be found in the file "helper.css".
                 ...
                 * Use class "tt-form-sm" or "tt-form-lg" to change form size (no class = default size).
                 -->
                <form class="tt-form-minimal anim-fadeinup" action="{{ route('send-message') }}"
                    method="POST">
                    @csrf
                    <div class="tt-row">
